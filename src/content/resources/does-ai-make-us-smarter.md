---
title: "Does AI Make Us Smarter?"
description: "The augmentation case, and why the panic literature is looking in the wrong place. A 44× multiplier on project creation rate, the heavy-user cohort nobody studies, and what the Kosmyna/Lee/Gerlich studies are actually measuring."
publishDate: 2026-04-23
category: "Opinion"
tags: ["AI", "Cognition", "Cyberpsychology", "Augmentation", "Claude Code", "Offloading", "Opinion"]
...
<div style="width:100%;border-radius:8px;overflow:hidden;margin:2rem 0;border:0.5px solid rgba(255,255,255,0.08);">
  <iframe src="/velocity/index.html" width="100%" height="1400" style="border:none;background:#F5F1EA;" title="Project creation velocity — four methodology eras"></iframe>
</div>
...
## <span style="color:#1F4E79">Three senses of the word</span>
...
## <span style="color:#1F4E79">The centaur observation</span>
...
## <span style="color:#1F4E79">The heavy-user cohort is the evidence</span>
...
## <span style="color:#1F4E79">What the panic studies are actually measuring</span>
...
## <span style="color:#1F4E79">The honest limits</span>
...
## <span style="color:#1F4E79">What a serious research programme would look like</span>
...
## <span style="color:#1F4E79">The clock-speed problem</span>
...
## <span style="color:#1F4E79">The answer</span>

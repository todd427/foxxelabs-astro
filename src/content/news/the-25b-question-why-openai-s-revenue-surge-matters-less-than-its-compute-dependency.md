---
title: "The $25B Question: Why OpenAI's Revenue Surge Matters Less Than Its Compute Dependency"
description: "As OpenAI approaches IPO and surpasses $25B annualized revenue, frontier models like GPT-5.4 expose a critical vulnerability: unsustainable compute costs and the infrastructure bottleneck reshaping AI's competitive landscape."
...
1. **Cost unpredictability**: As frontier models demand more compute, pricing pressure will intensify. Google's aggressive $0.25 pricing suggests margin compression across the board.

2. **Dependency lock-in**: European builders increasingly rely on US-based infrastructure. The EU AI Act's August 2026 enforcement deadline creates compliance costs that may only be affordable for builders using the largest, most-stable platforms.
...
---
**Source:** [OpenAI News & Industry Analysis](https://openai.com/news)
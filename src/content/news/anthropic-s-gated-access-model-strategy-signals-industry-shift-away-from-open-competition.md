---
title: "Anthropic's Gated Access Model Strategy Signals Industry Shift Away from Open Competition"
description: "Anthropic restricts Claude Mythos to 50 organizations citing security concerns, reshaping frontier AI access and raising questions about research equity."
...
— Will other frontier labs (OpenAI, Google DeepMind, Meta) follow suit with their own gated releases?
— How will the EU AI Act's transparency requirements interact with proprietary access restrictions?
— Does Project Glasswing constitute a competitive advantage that disadvantages EU-based startups?
— Will open-source models (Gemma, GLM, Qwen) sufficiently advance to reduce the capability gap?

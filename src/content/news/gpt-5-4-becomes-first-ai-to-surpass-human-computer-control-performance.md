---
title: "GPT-5.4 Becomes First AI to Surpass Human Computer Control Performance"
description: "OpenAI's latest model achieves 75% success rate on desktop navigation tasks, exceeding the 72.4% human baseline for the first time."

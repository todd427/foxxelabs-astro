---
title: "Artificial Epistemics' Bold Alignment Claims: Why 'Solving' AI Safety Requires Healthy Skepticism"
description: "New startup claims to have solved AI alignment through epistemic quality control—but fundamental safety challenges remain unsolved."
...
1. **What constitutes "truth" and "morality" algorithmically?** The protocol's specifics remain opaque. Truth is context-dependent; morality is culturally contested. How does Artificial Epistemics operationalize these concepts?

2. **Adversarial resilience**: Can epistemic filtering withstand jailbreaks or prompt injection designed to circumvent it?

3. **Coverage**: Does the protocol apply only to obvious failures, or does it address subtle misalignment in reasoning chains?

4. **Verification**: What independent evaluation has been conducted? Claims of "solving" alignment demand extraordinary evidence.
...
---
**Source:** [Artificial Epistemics Announcement](https://www.artificialeppistemics.com)